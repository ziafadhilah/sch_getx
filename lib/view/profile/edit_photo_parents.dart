...
class EditPhotoPageParent extends StatefulWidget {
  const EditPhotoPageParent({super.key});

  @override
  State<EditPhotoPageParent> createState() => _EditPhotoPageParentState();
}
...
class _EditPhotoPageParentState extends State<EditPhotoPageParent> {
  ...
  void initState() {
    super.initState();
    _imageUrl = '$imageUrl/${profile.photo}';
  }
  ...
  Future<void> _saveImageToServer() async {
    if (_imageUrl.isNotEmpty) {
      ...
      final String usertypeID = profile.usertypeId.toString();
      final String username = profile.username.toString();

      final bool success = await _profileController.uploadImage(
